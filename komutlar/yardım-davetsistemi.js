...
.setColor('#ffd100') 
.setAuthor(`Yinzeii Davet Sistemi`, client.user.avatarURL())
.setDescription(`<a:hypesquad1:750076071721828452> Yinzeii botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
